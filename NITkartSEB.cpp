...
void mainmenu1()
{
    ...
    cout<<"               Welcome to NITkart.com , the Website where you can shop anything from anywhere literally!!!";
    cout<<endl<<endl<<endl<<endl;
    cout<<"********************************************************************************************************************";
    cout<<endl<<endl<<endl<<endl;
    cout<<"1. Account\n";
    ...
    case 4:
        system("cls");
        cout<<" Thanks for using this NITkart.com Press any key to exit";
        getch();
        exit(1);
    default:
        mainmenu1();
